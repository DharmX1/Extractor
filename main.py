...
import Hydra as helper
from utils import progress_bar
from vars import API_ID, API_HASH, BOT_TOKEN, OWNER, AUTH_USER, CREDIT
...
photologo = 'https://wallpaperaccess.com/full/812043.png' #https://envs.sh/GV0.jpg
photoyt = 'https://static.vecteezy.com/system/resources/previews/014/039/537/large_2x/creative-chat-tv-logo-design-talk-show-logo-design-free-vector.jpg' #https://envs.sh/GVi.jpg
photocp = 'https://classplusapp.com/growth/wp-content/uploads/2022/06/classplus.png.jpg'
photozip = 'https://www.pngitem.com/pimgs/m/116-1169548_zip-icon-free-download-zip-file-icon-hd.png'


# Inline keyboard for start command
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="None")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="🛠️ Help", url="None"),
            InlineKeyboardButton(text="🛠️ Repo", url="https://github.com/DharmX1"),
        ],
    ]
)
...
image_urls = [
    "https://wallpaperaccess.com/full/812043.png",
...
async def yt2m_handler(bot: Client, m: Message):
    ...
    try:
        ...
        name = f'{audio_title[:60]} 🎀  𝐻𝒴𝒟𝑅𝒜 𝐵❀𝒯  🎀 '        
...
async def start(bot, m: Message):
    ...
    if m.chat.id in AUTH_USERS:
        await start_message.edit_text(
            ...
            f"If you face any problem contact -  [🎀  𝐻𝒴𝒟𝑅𝒜 𝐵❀𝒯  🎀 ](🎀  𝐻𝒴𝒟𝑅𝒜 𝐵❀𝒯  🎀  )\n", disable_web_page_preview=True, reply_markup=BUTTONSCONTACT
        )
    else:
